  ...
  (
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            "duration-200 fixed top-16 z-10 hidden h-svh w-[--sidebar-width] transition-[left,right,width] ease-linear md:flex",
            side === "left"
              ? "left-1.5 lg:left-20 group-data-[collapsible=offcanvas]:left-[calc(var(--sidebar-width)*-1)]"
...
// Fixed component with proper ref handling
